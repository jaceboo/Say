package com.ledonghuyu.sayhi.di;
...
public interface AppComponent {
     ...
     * 之前 {@link AppManager} 使用 Dagger 保证单例, 只能使用 {@link com.jess.arms.di.component.AppComponent#appManager()} 访问
     * 现在直接将 AppManager 独立为单例类, 可以直接通过静态方法 {@link AppManager#getAppManager()} 访问, 更加方便
     * 但为了不影响之前使用 {@link com.jess.arms.di.component.AppComponent#appManager()} 获取 {@link AppManager} 的项目, 所以暂时保留这种访问方式
     *
    ...
    interface Builder {
        @BindsInstance
        com.jess.arms.di.component.AppComponent.Builder application(Application application);

        com.jess.arms.di.component.AppComponent.Builder globalConfigModule(GlobalConfigModule globalConfigModule);

        com.jess.arms.di.component.AppComponent build();
    }
}